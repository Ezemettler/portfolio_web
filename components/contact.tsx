    ...
    <section id="contact" className="py-24 md:py-32 bg-secondary/30">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          {/* Left side */}
          <div>
            <p className="text-lg text-foreground/70 leading-relaxed mb-10 max-w-md text-pretty">
              {t.contact.subtitle}
            </p>
          ...
          <div className="flex flex-col gap-4">
            {links.map((link) => (
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-lg bg-card border border-border hover:border-primary/40 hover:bg-accent transition-all duration-200 group"
              >
